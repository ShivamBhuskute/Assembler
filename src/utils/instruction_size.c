...
OpcodeEntry op_table[] = {
    // MOV instructions
    {"mov", 0xB8, 0, 2, {{OP_REG, 0}, {OP_IMM, 2}}, 3},  // MOV reg, imm16, 3 bytes total
    ...
    {"add", 0x81, 0, 2, {{OP_REG, 0}, {OP_IMM, 2}}, 3},  // ADD reg, imm16, 3 bytes
    ...
    {"sub", 0x81, 5, 2, {{OP_REG, 0}, {OP_IMM, 2}}, 3},  // SUB reg, imm16, 3 bytes
